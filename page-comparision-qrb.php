<?php
/*
Template Name: Comparision: Quipli vs Booqable vs Rentle
...
$headers = ["Booqable", "Quipli", "Rentle"];
	...
	array(
		array(
			'heading' => array(
				...
				'subtitle' => '',
				'description' => "Both Booqable and Quipli also offer more robust plans with additional features and options for a higher monthly price while Rentle offers a lower price.
				Quipli is the only one of these three platforms that offers 24/7 customer support, via email or live chat. You’ll also have access to the Knowledge Base, FAQs, and user forums for additional information about how to get the most out of Quipli’s software."
			),
			'comparisons' => array(
				array(
					'label' => 'Year founded',
		...
		array(
			'heading' => array(
				...
				'description' => "Quipli, Booqable Quipli Rentle all offer a similar suite of core software features, with a few differences between them. For Booqable and Rentle, the pricing tier you choose will affect which features you’ll have access to."
			),
			'comparisons' => array(
				array(
		...
		array(
			'heading' => array(
				...
				'description' => "Rental business software can go a long way toward simplifying and streamlining your accounting and financials.
				Of the three, Quipli and Booqable offer more accounting features and functionality, as well as built-in invoicing for customer accounts."
			),
			'comparisons' => array(
				array(
					'label' => 'Accounting',
		...
		array(
			'heading' => array(
				...
				'description' => "Quipli is available on the web, for Android devices, and for iOS as a progress web app, making it simple to access everything you need to run your business on the go. Booqable is also available as an app, while Rentle does not provide any app functionality."
			),
			'comparisons' => array(
				array(
		...
		array(
			'heading' => array(
				...
				'description' => "All three platforms include an easy-to-use website builder for creating slick, intuitive sites where your users can view and rent your products.
				Quipli goes the extra mile when it comes to integration, connecting seamlessly with other important business software including Quickbooks, Google Maps, Stripe, and more."
			),
			'comparisons' => array(
				array(
		...
		array(
			'heading' => array(
				...
				'subtitle' => '',
				'description' => "Quipli offers growth webinars, live help and documentation for learning more about the platform while Booqable and Rentle only offer platform documentation."
			),
			'comparisons' => array(
				array(
	...
	array(
		array(
			'heading' => array(
				...
				Booqable, Rentle, and Quipli are all solid options for rental companies of a variety of sizes. If you’re a larger operation with multiple brick and mortar locations, Quipli’s built-in multi-location support gives it an edge."
			),
			'comparisons' => array(
				array(
		...
		<div class="max-container">
			<div class="pattern-bg pattern-x-both x-centered">
				<div class="page-heading">
					<h1>Booqable vs Rentle vs Quipli: which is the best?</h1>
		...
		<div class="qp-image-content-block primary">
			...
			<div class="qp-content-block qp-col-space-between">
				<div>
					...
					<p>
						While Booqable and Rentle cater more to smaller outfits –
