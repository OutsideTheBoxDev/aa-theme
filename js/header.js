jQuery(document).ready(function ($) {
  ...
  morphDropdown.prototype.bindEvents = function () {
    ...
    //click on an item in the sub navigation
    this.subNavigationItems.on("click", function (event) {
      var currentSubMenu = $(event.currentTarget);
      var currentSubMenuContent = currentSubMenu.find(".qp-menu-info-wrap");
      currentSubMenu
        .siblings(".submenu-visible")
        .find(".qp-menu-info-wrap")
        .slideUp();
      currentSubMenu
        .siblings(".submenu-visible")
        .removeClass("submenu-visible");
      if (!currentSubMenu.hasClass("submenu-visible")) {
        currentSubMenu.addClass("submenu-visible");
        currentSubMenuContent.slideDown();
      } else {
        currentSubMenu.removeClass("submenu-visible");
        currentSubMenuContent.slideUp();
      }
    });
    ...
    this.element.on("click", ".nav-trigger", function (event) {
      ...
      var submenus = $(".dropdown-list").find(".has-submenu");
      if (!self.element.hasClass("nav-open")) {
        $("body").removeClass("nav-opened");
        submenus.removeClass("submenu-visible");
        submenus.find(".qp-menu-info-wrap").removeAttr("style");
      } else {
