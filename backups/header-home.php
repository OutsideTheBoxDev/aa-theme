...
<body <?php body_class('no-js theme--default'); ?> dir="ltr">
	<?php wp_body_open(); ?>
	<header class="qp-header cd-morph-dropdown">
		...
		<div class="max-container relative">
			<div class="qp-header-inner">
					...
					<nav class="main-nav">
						<?php if($args['nav'] != 'hidden'):?>
							<ul>
								...
								<li class="has-dropdown use-cases" data-content="use-cases">
									<a href="#0">Use Cases</a>
								</li>
								...
								<li class="button">
									<a href="<?php echo home_url(); ?>/reviews/" title="Reviews">Reviews</a>
								</li>
				...
				<div class="qp-header-actions">
					...
					<a class="q-btn btn__header nav-demo-btn" title="Book a Demo" href="#/book-a-demo">Book a Demo</a>
					<?php if($args['nav'] != 'hidden'):?>
			...
			<div class="morph-dropdown-wrapper">
				<div class="dropdown-list">
					<ul>
						<li id="solutions" class="dropdown solutions has-submenu">
							...
							<div class="qp-menu-info-wrap">
								<div class="qp-sub-menu-grid">
									<ul class="qp-sub-grid-items">
                                    	<li class="qp-solutions-link">
                                		<div class="qp-shape-block qp-solutions-block">
                                			<div class="qps-icon-title">
                                				<div class="qps-icon">
                                					<img src="<?php echo get_template_directory_uri() ?>/assets/img/solutions-menu-icon.svg" alt="Solutions" width="72" height="72" />
                                				</div>
                                				<p>Product Overview</p>
                                			</div>
                                			<span>From inventory management to cycle billing, invoicing to payments, e-Commerce to service and repair, Quipli has you covered.</span>
                                            <a href="<?php echo home_url(); ?>/solutions/" class="btn-plain"> Learn More </a>
                                          </div>	
										</li>
										<li>
											<a href="<?php echo home_url(); ?>/solutions/equipment-inventory-management-software/" class="qp-sub-menu-info">
										...
										<li>
											<a href="<?php echo home_url(); ?>/solutions/rental-booking-and-scheduling-software/" class="qp-sub-menu-info">
												<div class="sub-menu-icon">
													<svg width="20px" height="20px" viewBox="0 0 20 20">
										...
										<li>
											<a href="<?php echo home_url(); ?>/solutions/rental-invoicing-billings-payments-software/" class="qp-sub-menu-info">
												<div class="sub-menu-icon">
													<svg width="20px" height="20px" viewBox="0 0 20 20">
										...
										<li>
											<a href="<?php echo home_url(); ?>/solutions/rental-website-builder/" class="qp-sub-menu-info">
												<div class="sub-menu-icon">
													<svg width="20px" height="20px" viewBox="0 0 20 20">
														<use xlink:href="#shopping-bag" />
													</svg>
												</div>
												<span>Rental Website Builder</span>
											</a>
										</li>
										<li>
											<a href="<?php echo home_url(); ?>/solutions/quickbooks-equipment-rental-software/" class="qp-sub-menu-info">
												<div class="sub-menu-icon">
										...
										<li>
											<a href="<?php echo home_url(); ?>/solutions/equipment-rental-maintenance-software/" class="qp-sub-menu-info">
												<div class="sub-menu-icon">
													<svg width="20px" height="20px" viewBox="0 0 20 20">
										...
										<li>
											<a href="<?php echo home_url(); ?>/solutions/digital-marketing-for-rental-businesses/" class="qp-sub-menu-info">
												<div class="sub-menu-icon">
													<svg width="20px" height="20px" viewBox="0 0 20 20">
														<use xlink:href="#seo" />
													</svg>
										...
										<li>
											<a href="<?php echo home_url(); ?>/solutions/rental-equipment-checkout-software/" class="qp-sub-menu-info">
												<div class="sub-menu-icon">
													<svg width="20px" height="20px" viewBox="0 0 20 20">
														<use xlink:href="#checkout-software" />
													</svg>
												</div>
												<span>POS & Checkout Software </span>
											</a>
										</li>
									</ul>
								</div>
								<div class="qp-submenu-content">
									<div class="qp-shape-block qp-solutions-block">
										...
										<p>Product Overview</p>
										<span>From inventory management to cycle billing, invoicing
											to payments, e-Commerce to service and repair, Quipli
											has you covered.</span>
										<a href="<?php echo home_url(); ?>/solutions" class="btn-plain"> Learn More </a>
									</div>
								</div>
							</div>
						</li>
						<li id="use-cases" class="dropdown use-cases has-submenu">
							<div class="qp-sub-menu-title">
								<p>Use Cases</p>
							</div>
							<div class="qp-menu-info-wrap">
								<div class="qp-sub-menu-grid">
									<ul class="qp-sub-grid-items">
										<li>
											<a href="<?php echo home_url(); ?>/general-tool-rental-software/" class="qp-sub-menu-info">
												<div class="sub-menu-icon">
													<svg width="20px" height="20px" viewBox="0 0 20 20">
														<use xlink:href="#general-tool" />
													</svg>
												</div>
												<span>General Tool</span>
											</a>
										</li>
										<li>
											<a href="<?php echo home_url(); ?>/construction-and-heavy-equipment-rental-software/" class="qp-sub-menu-info">
												<div class="sub-menu-icon">
													<svg width="20px" height="20px" viewBox="0 0 20 20">
														<use xlink:href="#equipment" />
													</svg>
												</div>
												<span>Construction & Heavy Equipment</span>
											</a>
										</li>
									</ul>
								</div>
								<div class="qp-submenu-content">
									<div class="qp-shape-block qp-use-cases-block">
										<div class="qp-shaped-img qp-left-shape">
											<picture>
												<source srcset="<?php echo get_template_directory_uri() ?>/assets/img/nextgen.webp" />
												<source srcset="<?php echo get_template_directory_uri() ?>/assets/img/nextgen.jpg" />
												<img src="<?php echo get_template_directory_uri() ?>/assets/img/nextgen.jpg" alt="Meet The next generation of equipment rental software" loading="lazy" decoding="async" width="498" height="420">
											</picture>
										</div>
										<div class="qp-shape-content">
											<div class="qps-text-with-icon">
												<span>Meet</span>
												<img src="<?php echo get_template_directory_uri() ?>/assets/img/quipli-logo-yellow.svg" alt="Quipli Logo" width="141" height="40" />
											</div>
											<p>
												The next generation of equipment rental software is
												finally here. Let us show you.
											</p>

											<a href="<?php echo home_url(); ?>/book-a-demo/" class="btn-plain">Book a Demo</a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="qp-menu-info-wrap">
								<div class="qp-sub-menu-grid">
									<ul class="qp-sub-grid-items">
										<li>
											...
											<ul>
												<li>
													<a href="<?php echo home_url(); ?>/equipment-rental-templates/"><span>Templates</span></a>
												</li>
												<li>
													<a href="<?php echo home_url(); ?>/equipment-rental-calculators/"><span>Calculators</span></a>
												</li>
											</ul>
										</li>
										<li>
											...
											<ul>
												...
												<li>
													<a href="https://therentalroundtable.com/" target="_blank"><span>The Rental Roundtable</span></a>
												</li>
											</ul>
										</li>
										<li class="full-grid">
											...
											<ul>
												<li>
													<a href="<?php echo home_url(); ?>/equipment-rental-software-comparison-guide/"><span>Comparison</span></a>
												</li>
												<li>
													<a href="<?php echo home_url(); ?>/equipment-rental-marketing-guides/"><span>Marketing & Growth Guides</span></a>
												</li>
												<li>
								...
								<div class="qp-submenu-content">
									<div class="qp-shape-block qp-resources-block">
										...
										<span class="featured-date">New Features</span>
										<div class="qp-resources-featured-content">
											<p>
												Check out our equipment rental software comparison
												guide. Happy shopping.
											</p>
											<a href="<?php echo home_url(); ?>/equipment-rental-software-comparison-guide/" class="btn-plain"> Learn More </a>
										</div>
									</div>
								</div>
							</div>
